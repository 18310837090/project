...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCameraFaceButton = findViewById(R.id.button_face);
        ...
        mCameraFaceButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                runCameraFaceContourDetection();
            }
        });
        ...
        String[] items = new String[]{"文本识别1", "文本识别2", "人脸识别", "物体检测1", "物体检测2"};
    ...
    private void runCameraFaceContourDetection() {
        cameraSourcePreview = new CameraSourcePreview(MainActivity.this,camera);
//        FirebaseVisionImage image = FirebaseVisionImage.fromBitmap(tmp_image);
