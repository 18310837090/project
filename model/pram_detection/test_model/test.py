# -*- coding:utf-8 -*-
import sys
sys.path.append('/home/xiaojing/tensorflow/models/research/')
...
img_file = os.listdir(config.TEST_IMAGE_PATHS)
for img in img_file:
  image = Image.open(os.path.join(config.TEST_IMAGE_PATHS, img))
  image_np = load_image_into_numpy_array(image)
  # Expand dimensions since the model expects VOC2012 to have shape: [1, None, None, 3]
